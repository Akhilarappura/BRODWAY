...
//         const orders = await orderdb.find().populate('items.productId');
//         const products = await productdb.find();
//         const categories = await categorydb.find(); // Assuming you have a categorydb model
...
//                 if (product) {
//                     if (!brandSales[product.brand]) {
//                         brandSales[product.brand] = 0;
//                     }
//                     brandSales[product.brand] += item.quantity;
//                 }
//             });
//         });
